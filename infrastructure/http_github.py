...
from typing import Any, Callable, Dict, List, Optional  # 标准库:类型注解
...
class GitHubApiClient:
    ...
    def __init__(
        ...
        self.default_headers: Dict[str, str] = {  # 初始化默认请求头
            ...
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36",  # 浏览器UA:GitHub对缺UA/非浏览器UA请求返回403
        }
